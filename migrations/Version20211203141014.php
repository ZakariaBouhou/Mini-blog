 ...
 */
final class Version20211203141014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (articleid INT AUTO_INCREMENT NOT NULL, userid INT DEFAULT NULL, title VARCHAR(64) DEFAULT NULL, content LONGTEXT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX userid (userid), PRIMARY KEY(articleid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (userid INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(64) DEFAULT NULL, email VARCHAR(64) DEFAULT NULL, created_at DATETIME DEFAULT NULL, PRIMARY KEY(userid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
